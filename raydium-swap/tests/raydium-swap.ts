...
describe("raydium-swap", () => {
  ...
  const poolState2 = new anchor.web3.PublicKey("HRn16fqH3gR8xXgxgRxHY4M2unraFYTapgz8JLJRAvck");

  const observationState1 = new anchor.web3.PublicKey("Di7B23MeqnjUfuD2DMRKLtX4o1gad88B7r4CRvhgHGib");
  const observationState2 = new anchor.web3.PublicKey("1iDWLzyRDTnvaAxW7tT8rJYViG1ktx9CS4AvgeJ8pdb");
  ...
  const tokenAccount3 = new anchor.web3.PublicKey("AZWJgHt4vtHPKXzGVbhijwUdGXcXCTowf8Qq1ttKGLGv");
  const tokenAccount4 = new anchor.web3.PublicKey("52YxvprHrGEK3mjReyjxP9uf7cUnQebL82tXwYJB8BP8");
  ...
  const tokenVault3 = new anchor.web3.PublicKey("sohUc9fNVXwRhpoA1m4TYTmkn3hGwBB53Yw6kRL62h3");
  const tokenVault4 = new anchor.web3.PublicKey("H2xBLMD5DZ8Sgk1xfNv6MuHVA1Nvur8UY5EZ3TZt278V");
  ...
  const tokenMint3 = new anchor.web3.PublicKey("So11111111111111111111111111111111111111112");
  const tokenMint4 = new anchor.web3.PublicKey("686P1DCV27RYVkiq5rgh74nQqWfV5W6itB2gBJtqNPHy");
  ...
  const otherAccount4 = new anchor.web3.PublicKey("EqsToU5h55zkrT4APCGku8nfVbNQMXHUeRnDEqtETELz");
  const otherAccount5 = new anchor.web3.PublicKey("FRemXN1aJ1H1ApRMVhMKKmx83KFJrV2sUbVnxR3Q8fqR");
  const otherAccount6 = new anchor.web3.PublicKey("2Mjgy6E2peVE5VF6bZDTWsWAeZtsymh8636okLqUxVYp");
  ...
  it("tests the swap function", async () => {
    ...
    const remainingAccounts = [
      ...
      { pubkey: tokenAccount4, isSigner: false, isWritable: true },
      ...
      { pubkey: tokenMint4, isSigner: false, isWritable: false },
